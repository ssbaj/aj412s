...
cat("  ", '\n')
cat("\033[1;33m# BASIC 막대그래프 with ggplot -------------------\033[0m ", '\n')
cat(" \033[1;33m theme_set(theme_bw(base_size=22))     \033[0m ", '\n')
cat(" \033[1;33m df <- data.frame(     \033[0m ", '\n')
cat(" \033[1;33m   supp = rep(c('VC', 'OJ'), each = 3),     \033[0m ", '\n')
cat(" \033[1;33m   dose = rep(c('D0.5', 'D1', 'D2'), 2),     \033[0m ", '\n')
cat(" \033[1;33m   len = c(6.8, 15, 33, 4.2, 10, 29.5)     \033[0m ", '\n')
cat(" \033[1;33m   )       \033[0m ", '\n')
cat("  ", '\n')
cat(" \033[1;33m   head(df)   \033[0m ", '\n')
cat("  ", '\n')
cat(" \033[1;33m   p <- ggplot(df, aes(x = dose, y = len))+   \033[0m ", '\n')
cat(" \033[1;33m     geom_col(aes(fill = supp), width = 0.7)   \033[0m ", '\n')
cat(" \033[1;33m   p + coord_flip()   \033[0m ", '\n')
cat("  ", '\n')
invisible(readline(prompt="Press [enter] to continue"))
cat("  ", '\n')
