...
cat("  df2 <- df[ complete.cases(df), ]  \033[1;31m## 미싱데이터NA 삭제 \033[0m ", '\n')
...
cat("   ", '\n')
cat("\033[1;31m## 데이터프레임의 특정 변수column 지우기 ------- \033[0m", '\n') 
cat("  df <- df[ , -c(2, 4:5)] ", '\n')
cat("   ", '\n')
...
cat("  \033[1;33maj412s의 opencsv로 csv파일을 로딩하면 csv파일의 blank문제는 신경쓰지 않아도 됩니다\033[0m ", '\n')
cat("   ", '\n')
